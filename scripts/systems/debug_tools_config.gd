...
const DEBUG_DISABLE_REALTEST1_BOB_NPC := false
const DEBUG_DISABLE_REALTEST1_DAD_NPC := false
const DEBUG_DISABLE_REALTEST1_MAID_NPC := false
const DEBUG_DISABLE_REALTEST1_MOM_NPC := false

# Definition-specific suspects
const DEBUG_DISABLE_MOM_MEAL_SPOT := false
const DEBUG_DISABLE_MOM_WORK_SPOT := false
